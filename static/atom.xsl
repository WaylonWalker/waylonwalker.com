    ...
    <xsl:template match="/">
        ...
        <body>
            ...
            <div id="title-wrapper">
                <a class="u-url" href="https://waylonwalker.com/{{ slug|trim('/') }}/">
                    <h1 id="title"
                        style="text-align: right; z-index: 2; padding-right: 0.2rem; text-wrap: balance; font-size: 4rem;"
            ...
            <div id="post-body">
                <p style="margin: 2rem;">This is a styled rss/atom feed.</p>
                <p style="margin: 2rem;">It's styled xml.</p>
                <p style="margin: 2rem; margin-top: 0; margin-bottom: 4rem;">
                    YES, that means you can use this feed in your reader.
                </p>
                ...
                <ul>
                    ...
                    <xsl:for-each select="/atom:feed/atom:entry">
                        <li class="post">
                            <h2 class="title">
                                <a target="_blank">
                                    <!-- href from atom:link (prefer rel='alternate') -->
