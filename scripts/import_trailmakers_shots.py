...
DEFAULT_SOURCE_DIR = Path(
    ...
    "waylonwalker-gaming/trailmakers-pioneers-2"
)
...
def render_markdown(meta: ShotMeta, image_url: str) -> str:
    return "\n".join(
        [
            ...
            "templateKey: shots",
            f"title: trailmakers pioneers second run - {meta.title}",
            "tags:",
            "  - shots",
            "  - trailmakers",
            "published: True",
            ...
            "",
            f"> {meta.description}, During my second trailmakers pioneers run.",
            "",
        ]
    )
